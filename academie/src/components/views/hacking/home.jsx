      ...
      <div>
        ...
        <div className='page'>
          <div className='content'>
            <p>
              Il est entièrement légal de pirater son propre ordinateur, de la même manière qu'il est légal de crocheter sa propre serrure. Il en va de même pour les machines dont les propriétaires vous ont donné par écrit l'autorisation de pirater.<br/>
              ...
              <br/>
              Beaucoup de cours sur la cybersécurité (infosec, ethical hacking et autres) sont payants. Nous ne doutons pas du fait que ces cours sont de très bonnes qualité, mais nous pensons qu'il est possible d'acquérir un ensemble de connaissances assez important sur le sujet sans dépenser un sou. Tout le contenu que nous référençons est donc gratuit d'accès.<br/>
              <br/>
